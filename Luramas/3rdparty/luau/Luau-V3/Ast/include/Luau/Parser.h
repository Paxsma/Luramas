...
#include "Luau-V3/Ast/include/Luau/DenseHash.h"
#include "Luau-V3/Ast/include/Luau/Lexer.h"
#include "Luau-V3/Ast/include/Luau/ParseOptions.h"
#include "Luau-V3/Ast/include/Luau/ParseResult.h"
#include "Luau-V3/Ast/include/Luau/StringUtils.h"
...
namespace Luau {
      ...
      class Parser {
          ...
          private:
            ...
            AstType *parseFunctionTypeAnnotationTail(const Lexeme &begin, AstArray<AstGenericType> generics, AstArray<AstGenericTypePack> genericPacks, AstArray<AstType *> &params, AstArray<std::optional<AstArgumentName>> &paramNames, AstTypePack *varargAnnotation);
            ...
            AstStatError *reportStatError(const Location &location, const AstArray<AstExpr *> &expressions, const AstArray<AstStat *> &statements, const char *format, ...) LUAU_PRINTF_ATTR(5, 6);
