...
#include "Luau-V3/Ast/include/Luau/Location.h"
...
#define LUAU_RTTI(Class)                  \
      ...
      class AstStatIf : public AstStat {
          public:
            ...
            AstStatIf(const Location &location, AstExpr *condition, AstStatBlock *thenbody, AstStat *elsebody, const std::optional<Location> &thenLocation, const std::optional<Location> &elseLocation, bool hasEnd);
      ...
      class AstStatLocal : public AstStat {
          public:
            ...
            AstStatLocal(const Location &location, const AstArray<AstLocal *> &vars, const AstArray<AstExpr *> &values, const std::optional<Location> &equalsSignLocation);
      ...
      class AstStatFor : public AstStat {
          public:
            ...
            AstStatFor(const Location &location, AstLocal *var, AstExpr *from, AstExpr *to, AstExpr *step, AstStatBlock *body, bool hasDo, const Location &doLocation, bool hasEnd);
      ...
      class AstStatForIn : public AstStat {
          public:
            ...
            AstStatForIn(const Location &location, const AstArray<AstLocal *> &vars, const AstArray<AstExpr *> &values, AstStatBlock *body, bool hasIn, const Location &inLocation, bool hasDo, const Location &doLocation, bool hasEnd);
      ...
      class AstStatTypeAlias : public AstStat {
          public:
            ...
            AstStatTypeAlias(const Location &location, const AstName &name, const AstArray<AstGenericType> &generics, const AstArray<AstGenericTypePack> &genericPacks, AstType *type, bool exported);
      ...
      class AstStatDeclareFunction : public AstStat {
          public:
            ...
            AstStatDeclareFunction(const Location &location, const AstName &name, const AstArray<AstGenericType> &generics, const AstArray<AstGenericTypePack> &genericPacks, const AstTypeList &params, const AstArray<AstArgumentName> &paramNames, const AstTypeList &retTypes);
      ...
      class AstTypeReference : public AstType {
          public:
            ...
            AstTypeReference(const Location &location, std::optional<AstName> prefix, AstName name, bool hasParameterList = false, const AstArray<AstTypeOrPack> &parameters = {});
      ...
      class AstTypeFunction : public AstType {
          public:
            ...
            AstTypeFunction(const Location &location, const AstArray<AstGenericType> &generics, const AstArray<AstGenericTypePack> &genericPacks, const AstTypeList &argTypes, const AstArray<std::optional<AstArgumentName>> &argNames, const AstTypeList &returnTypes);
