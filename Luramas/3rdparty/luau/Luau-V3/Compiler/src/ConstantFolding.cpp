...
namespace Luau {
      namespace Compile {
            ...
            struct ConstantVisitor : AstVisitor {
                  ...
                  ConstantVisitor(DenseHashMap<AstExpr *, Constant> &constants, DenseHashMap<AstLocal *, Variable> &variables, DenseHashMap<AstLocal *, Constant> &locals, const DenseHashMap<AstExprCall *, int> *builtins)
                      : constants(constants), variables(variables), locals(locals), builtins(builtins) {
            ...
            void foldConstants(DenseHashMap<AstExpr *, Constant> &constants, DenseHashMap<AstLocal *, Variable> &variables, DenseHashMap<AstLocal *, Constant> &locals, const DenseHashMap<AstExprCall *, int> *builtins, AstNode *root) {
